...
public class WebElementWithAllAttributes extends GenericElement {
    ...
    public String getAutofocus() {
        return getAttribute("autofocus");
    }

    public String getAutoplay() {
        return getAttribute("autoplay");
    }

    public String getAutosave() {
        return getAttribute("autosave");
    }
    ...
    public String getContextmenu() {
        return getAttribute("contextmenu");
    }

    public String getControls() {
        return getAttribute("controls");
    }
    ...
    public String getDraggable() {
        return getAttribute("draggable");
    }

    public String getDropzone() {
        return getAttribute("dropzone");
    }
    ...
    public String getHttp_equiv() {
        return getAttribute("http_equiv");
    }
    ...
    public String getNovalidate() {
        return getAttribute("novalidate");
    }
    ...
    public String getRequired() {
        return getAttribute("required");
    }

    public String getReversed() {
        return getAttribute("reversed");
    }
    ...
    public String getSandbox() {
        return getAttribute("sandbox");
    }

    public String getSpellcheck() {
        return getAttribute("spellcheck");
    }
    ...
    public String getScoped() {
        return getAttribute("scoped");
    }

    public String getSeamless() {
        return getAttribute("seamless");
    }
