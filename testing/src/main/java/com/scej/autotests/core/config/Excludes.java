...
package com.scej.autotests.core.config;
...
/**
 * <p>Java class for Excludes complex type.
 * 
...
@XmlType(name = "Excludes")
public class Excludes implements SpecificationHolder{
    ...
    public Excludes(List<Specification> specifications) {
